...
class Contact extends Component {
    ...
    handleSubmit(values) {
        console.log("Current State of application: " + JSON.stringify(values));
        alert("Current State of application: " + JSON.stringify(values));
    }
    render() {
        return(
